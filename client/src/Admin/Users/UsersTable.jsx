    ...
    >
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-700">
          <thead>
            <tr>
              <th className="px-6 py-3 text-xs text-left font-medium text-gray-400 uppercase tracking-wider">
                Name
              </th>
              <th className="px-6 py-3 text-xs text-left font-medium text-gray-400 uppercase tracking-wider">
                Email
          ...
          <tbody className="divide-y divide-gray-700">
            {USERS_DATA.map((user) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="px-2 inline-flex text-xs leading-5 font-medium rounded-full bg-blue-800 text-blue-100">
                    {user.role}
                  </span>
                </td>
