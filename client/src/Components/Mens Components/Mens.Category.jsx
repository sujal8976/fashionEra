...
export default function MensCategory() {
  ...
  return (
    <>
      <div className="mensCategory py-[50px] flex justify-center">
        <div className="mensCategoryContainer  w-[1400px] flex flex-col gap-12">
          ...
          <div className="mensCategory self-center">
            <Slide>
              {catInfo.map((info, i) => {
